...
| E1-F1-I1 | .env.example; .env.testing; composer.json; composer.lock; config/app.php; config/services.php; app/Providers/RouteServiceProvider.php; app/Providers/AppServiceProvider.php; app/Models/User.php; app/Support/AuditLogger.php; app/Logging/CustomizeFormatter.php; app/Http/Controllers/Auth/*; app/Http/Requests/Auth/LoginRequest.php; routes/auth.php; routes/api.php; routes/web.php; database/migrations/0001_01_01_000003_create_sessions_table.php; database/migrations/0001_01_01_000004_create_password_reset_tokens_table.php; database/seeders/DatabaseSeeder.php; resources/views/layouts/guest.blade.php; resources/views/components/*; resources/views/auth/*; README.md; CHANGELOG.md; COVERAGE_LEDGER.md; tests/Feature/AuthenticationScaffoldingTest.php | tests/Feature/AuthenticationScaffoldingTest.php | /login, /register, /forgot-password, /reset-password, /verify-email, /email/verification-notification | 0001_01_01_000003_create_sessions_table.php; 0001_01_01_000004_create_password_reset_tokens_table.php | Breeze authentication scaffolding with audit logging, rate limits, and guest UI |
