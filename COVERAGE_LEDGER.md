...
| Public Delivery & Frontend | `HealthController` | `/health`, `/api/health` routes, Nginx config | `tests/Feature/HealthcheckTest.php` |
...
| API & Headless Mode | `ApiToken`, `Webhook`, `ApiLog` | `/api/health`, queue + webhook stubs | `tests/Feature/HealthcheckTest.php` |
